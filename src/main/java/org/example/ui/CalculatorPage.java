...
public class CalculatorPage extends BasePage {
    ...
    public static final String PAGE_URL = System.getProperty("siteUrl") +
            PropertyReader.getConf().apiVersion() +
            System.getProperty("siteLanguage") +
            "-" +
            System.getProperty("siteCountry") +
            PropertyReader.getConf().calculatorUrl();
